        ...
        <div class="card-header">
            <div class="row justify-content-between align-items-center flex-grow-1">
                    ...
                    <form action="{{ route('find_trac_nghiem') }}" method="GET">
                        ...
                        <div class="input-group input-group-merge input-group-flush">
                            ...
                            <input id="datatableSearch" type="search" class="form-control"
                                ...
                                placeholder="Tìm kiếm bộ đề trắc nghiệm" aria-label="Search users">
                ...
                <div class="col-sm-6 col-md-4 mb-3 mb-sm-0 d-flex justify-content-end">
                    <a href="{{ Request::root() . '/' . 'admin/them-bai-trac-nghiem' }}"
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    ...
                                    @if (session()->get('role') == 'admin')
                                        <a class="btn btn-sm btn-white"
                                            href="{{ route('delete_trac_nghiem', ['id' => $item->id]) }}"
                                            onclick="return confirm('Bạn có chắc muốn xóa đề kiểm tra {{ $item->title }} không?')">
